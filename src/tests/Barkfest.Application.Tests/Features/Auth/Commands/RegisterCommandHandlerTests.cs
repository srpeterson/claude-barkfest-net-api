...
public class RegisterCommandHandlerTests
{
    ...
    public async Task Handle_When_CommandIsValid_Returns_ValidGuid()
    {
        ...
        var command = new RegisterCommand("newuser", "Alice", "Adams", "new@example.com", null, "pass123");
    ...
    {
        _ownerRepository.GetByUsernameAsync("aliceadams", CancellationToken.None).Returns((Owner?)null);
        ...
        var command = new RegisterCommand("aliceadams", "Alice", "Adams", "alice@example.com", null, "mypassword");
    ...
    {
        var existing = new OwnerBuilder().WithUsername("taken").Build();
        _ownerRepository.GetByUsernameAsync("taken", CancellationToken.None).Returns(existing);
