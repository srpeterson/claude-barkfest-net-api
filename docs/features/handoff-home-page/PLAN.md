# Plan — Bootstrap Home Page

## Goal

Import the Claude Design handoff for the home page into `barkfest-ui`, resolve all
CSS conflicts and component issues, and verify the page renders cleanly. No API
wiring in this phase — UI only.
